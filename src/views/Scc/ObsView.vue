...
<CModal :visible="modalDetalleObs" @close="clickModalDetalleObs(false)">
    ...
    <CModalFooter>
        ...
        <CButton @click="updateObsEstado(obsDetalle.id,1)" color="success" class="font"><CIcon icon="cil-check-alt" class="me-2"/>Aprobar</CButton>
    </CModalFooter>
</CModal>
...
export default {
    ...
    methods:{
        ...
        async getListaTipoEmpleado() { // Funcion para listar El tipo de Empleado
