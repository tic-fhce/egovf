...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        //Nuevo
        path: "/detallesEquipo/:id/:cifCiudadano?/:sw?",
      ...
      },
      {
        ...
        name: "inventario",
        component: () => import("@/modules/egovf-inv/viewsCiudadano/InventarioCiudadanoView.vue"),
      },
      {
        //Nuevo
        path: "/umoduloinv",
        name: "ModuloInvView",
        component: () => import("@/modules/egovf-inv/viewsCiudadano/ModuloInvView.vue"),
      },
      {
        //Nuevo
        path: "/todosEquipoView/:cifCiudadano/:sw?",
        name: "TodosEquipoView",
        component: () => import("@/modules/egovf-inv/viewsCiudadano/TodosEquipoView.vue"),
      },
      {
        //Nuevo
        path: "/atencionesporCif/:cifCiudadano/:sw?",
        name: "AtencionesporCifView",
        component: () => import("@/modules/egovf-inv/viewsCiudadano/AtencionesporCifView.vue"),
      },
