                    ...
                    <CRow>
                        <CCol :lg="6">
                            <div class="align-items-center">
                                ...
                                <label class="mb-0 fs-6 text-white">Reporte de Asistencia del mes de {{ mes }} de
                        ...
                        <CCol :lg="6" class="text-end">
                            <CDropdown variant="btn-group">
                                ...
                                <CDropdownMenu>
                                    <CDropdownItem>
                                        <CButton @click="pdf()" size="sm">
                                            <CIcon icon="cil-cloud-download" class="me-2" />Descargar Reporte
                                        </CButton>
                                    </CDropdownItem>
                                </CDropdownMenu>
                            </CDropdown>
                            ...
                            <table class="table table-striped table-hover" id="printHorario">
                                <tbody>
                                    ...
                                    <tr v-for="horario in reporte.listaHorario" :key="horario.horario_id">
                                        <td>
                                            <CBadge color="light" class="datos">ID Horario : {{ horario.horario_id }}</CBadge>
                                        </td>
                                        <td>
                                    ...
                                    <tr v-for="value in listaReporte" :key="value.id">
                                        ...
                                        <td>
                                            <div class="obserbaciones" v-for="listobs in value.obsDtoReporte"
                                                :key="listobs.id">
                                                <CBadge color="info">{{ listobs.uidobs }} | {{ listobs.tipo }}</CBadge>
                                                <br>
...
export default {
    ...
    methods: {
        ...
        pdf() { //Funcion que Constuye el PDF del reporte
            ...
            doc.setFontSize(6);
            doc.text("Fecha de Impresión: " + fecha, 120, 86);
            doc.setFontSize(10);
            var finalY = 95;
