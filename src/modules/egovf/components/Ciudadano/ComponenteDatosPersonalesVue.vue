                        ...
                        <CTabPane :visible="tab == 1">
                            <CRow>
                                ...
                                <CCol :lg="5">
                                    <br>
                                    <ul>
                                        <li class="lista">Nombre : {{egovf.nombre}}</li>
                                        <li class="lista">Apellidos : {{egovf.paterno}} {{egovf.materno}}</li>
                        ...
                        <CTabPane :visible="tab == 2">
                            <CRow>
                                ...
                                <CCol :lg="5">
                                    <br>
                                    <ul>
                                        <li class="lista">ID app : {{egovf.idUsuario}}</li>
                                        <li class="lista">CIF : {{egovf.cif}}</li>
                                        <li class="lista">Matricula : {{egovf.matricula}}</li>
                                        <li class="lista">C.I. : {{egovf.ci}}</li>
                                    </ul>
                                </CCol>
                                <CCol :lg="5">
                                    ...
                                    <ul>
                                        ...
                                        <li class="lista">Unidad : {{ egovf.sigla }}</li>
                                    </ul>
                                </CCol>
                            </CRow> 
                        </CTabPane>
                        ...
                        <CTabPane :visible="tab == 3">
                            <CRow>
                                ...
                                <CCol :lg="10">
                                    ...
                                    <ul>
                                        <li class="lista">Matricula :{{egovf.matricula}}</li>
                                        <li class="lista"><CButton color="success" class="font" size="sm" @click="clickModalCelular(true)"> {{egovf.celular}}</CButton></li>
                                        <li class="lista">Correo : {{egovf.correo}}</li>
                                        <li class="lista"><CButton color="success" class="font" size="sm" @click="clickModalPass(true)"> Actualizar Contraseña</CButton></li>
                                    </ul>
                                </CCol>
                            </CRow>
                        </CTabPane>
...
<CModal :visible="modalPass" @close="clickModalPass(false)">
    ...
    <CModalBody>
        ...
        <hr>
        <div class="mb-3 row">
            <label for="nueva" class="col-sm-12 col-form-label">La Contrasena se Actializara al CIF del Ciudadano </label>
        </div>
