<template>
    <CRow>
        ...
        <CCol :lg="6">
            <CCard>
                <CCardHeader class="headercolor">
                    <h6>
                        <CIcon icon="cil-description" size="lg" class="me-2" />Datos Personales
                    </h6>
                </CCardHeader>
                <CCardBody>
                    <CCol :sm="12">
                        <CWidgetStatsC class="mb-3" :value="'CIF: ' + egovf.cif"
                            :progress="{ color: 'success', value: 100 }" title="Visitors">
                            <template #icon>
                                <img :src="egovf.foto" class="img-fluid rounded-start" alt="..."><br>
                                <CButton color="dark" @click="clickModalFoto(true)" size="sm" class="mt-2">
                                    <CIcon icon="cil-camera" class="me-1"></CIcon> Actualizar Foto
                                </CButton>
                            </template>
                            <template #title>
        ...
        <CCol :lg="6">
            ...
            <CCard>
                <CCardHeader class="headercolor">
                    <h6>
                        <CIcon icon="cil-at" size="lg" class="me-2" />Datos E-govf
                    </h6>
                </CCardHeader>
                <CCardBody>
                    <CNav variant="tabs" class="nav nav-tabs">
                        <CNavItem>
                            <CNavLink :active="tab == 1" @click="clicktab(1)">
                                <CButton size="sm">
                                    <CIcon icon="cil-user"></CIcon><label class="d-none d-md-flex me-auto">Datos</label>
                                </CButton>
                            </CNavLink>
                        </CNavItem>
                        <CNavItem>
                            <CNavLink :active="tab == 2" @click="clicktab(2)">
                                <CButton size="sm">
                                    <CIcon icon="cil-pencil"></CIcon><label
                                        class="d-none d-md-flex me-auto">Actualizar</label>
                                </CButton>
                            </CNavLink>
                        </CNavItem>
                    </CNav>
                    <CTabContent>
                        ...
                        <CTabPane :visible="tab == 2">
                            ...
                            <CInputGroup size="sm" class="mb-3">
                                <CInputGroupText as="label">Celular</CInputGroupText>
                                <CFormInput type="text" :value="egovf.celular" disabled />
                                <CButton type="button" color="success" class="font" size="sm"
                                    @click="clickModalCelular(true)">
                                    Actualizar</CButton>
                            </CInputGroup>
                            ...
                            <CInputGroup size="sm" class="mb-3">
                                ...
                                <CButton type="button" color="success" class="font" size="sm"
                                    @click="clickModalPass(true)">
                                    Actualizar Contraseña</CButton>
                            </CInputGroup>
                        </CTabPane>
                    </CTabContent>
                </CCardBody>
    ...
    <CModal :visible="modalCelular" @close="clickModalCelular(false)">
        <CModalHeader class="headercolor" dismiss @close="clickModalCelular(false)">
            <CModalTitle>
                <h6>
                    <CIcon icon="cil-at" size="lg" class="me-2" />Actualizar Numero de Celular
                </h6>
            </CModalTitle>
        </CModalHeader>
        <CModalBody>
        ...
        <CModalFooter>
            <CButton @click="clickModalCelular(false)" color="danger" class="font" size="sm">
                <CIcon icon="cil-x" class="me-2" />Cancelar
            </CButton>
            <CButton @click="updatePersona()" color="success" class="font" size="sm">
                <CIcon icon="cil-check-alt" class="me-2" />Actualizar
            </CButton>
        </CModalFooter>
    </CModal>
    ...
    <CModal :visible="modalPass" @close="clickModalPass(false)">
        <CModalHeader class="headercolor" dismiss @close="clickModalPass(false)">
            <CModalTitle>
                <h6>
                    <CIcon icon="cil-at" size="lg" class="me-2" />Actualizar Contraseña
                </h6>
            </CModalTitle>
        </CModalHeader>
        <CModalBody>
        ...
        <CModalFooter>
            <CButton @click="clickModalPass(false)" color="danger" class="font" size="sm">
                <CIcon icon="cil-x" class="me-2" />Cancelar
            </CButton>
            <CButton v-if="botones" @click="updatePass()" color="success" class="font" size="sm">
                <CIcon icon="cil-check-alt" class="me-2" />Actualizar
            </CButton>
        </CModalFooter>
    </CModal>
    ...
    <CModal :visible="modalFoto" @close="clickModalFoto(false)">
        <CForm @submit.prevent="updateFoto()" enctype="multipart/form-data">
            <CModalHeader class="headercolor" dismiss @close="clickModalFoto(false)">
                <CModalTitle>
                    <h6>
                        <CIcon icon="cil-description" size="lg" class="me-2" />Actualizar Foto de Perfil
                    </h6>
                </CModalTitle>
            </CModalHeader>
            <CModalBody>
            ...
            <CModalFooter>
                <CButton @click="clickModalFoto(false)" color="danger" class="font" size="sm">
                    <CIcon icon="cil-x" class="me-2" />Cancelar
                </CButton>
                <CButton type="submit" class="font" color="success" size="sm">
                    <CIcon icon="cil-camera" class="me-2" />Actualizar
                </CButton>
            </CModalFooter>
        </CForm>
    </CModal>
