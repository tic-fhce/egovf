                    ...
                    <CTabContent>
                        <CTabPane :visible="tab == 1">
                            ...
                            <ul>
                                ...
                                <li class="lista">C.I. : {{egovf.ci}} {{egovf.complemento}}</li>
                                <li class="lista">Correo : {{egovf.correo}}</li>
                                <li class="lista">Celular : {{egovf.celular}}</li>
                        ...
                        <CTabPane :visible="tab == 2">
                            ...
                            <ul>
                                ...
                                <li class="lista">C.I. : {{egovf.ci}} </li>
                                <li class="lista">Unidad : {{ egovf.sigla }}</li>
                                <li class="lista"><CButton color="success" class="font" size="sm" @click="clickModalCelular(true)">Actualizar {{egovf.celular}}</CButton></li>
                                <li class="lista">Correo : {{egovf.correo}}</li>
