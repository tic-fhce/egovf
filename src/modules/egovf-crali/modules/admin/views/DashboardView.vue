        ...
        <table class="min-w-full bg-white">
          <thead class="bg-gray-800 text-white">
            <tr>
              ...
              <th class="w-30 text-left py-3 px-3 uppercase font-semibold text-sm">Acciones</th>
            </tr>
          </thead>
          <tbody class="text-gray-700">
            <!-- <tr v-for="(product, index) in products" :key="product.id" :class="{
              ...
              <td class="">
                <ButtonED :term="`/admin/products/${product.id}`" />
              </td>
            </tr> -->
          </tbody>
        </table>
...
// import ButtonED from '@/modules/common/components/ButtonED.vue';
