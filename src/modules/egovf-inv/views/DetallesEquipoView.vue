<template>
    ...
    <nav v-if="cif == '' " aria-label="breadcrumb">
    ...
    <nav v-if="sw == '1'">
        <ol class="breadcrumb custom-breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">
          <label @click="irlistaEquipos(cif)" class="breadcrumb-link">
            Listado de Equipos
          </label>
          </li>
          <li class="breadcrumb-item active" aria-current="page">
    ...
    <nav v-if="cif != ''" aria-label="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">
        <CIcon @click="irCiudadano(cif)" class="breadcrumb-link menuicon" icon="cil-user"/>
      </li>
      <li class="breadcrumb-item active" aria-current="page">
        <label @click="irInventario(cif)" class="breadcrumb-link">{{ cif }}</label>
      </li>
      <li class="breadcrumb-item active" aria-current="page">
        <label @click="irListado(cif)" class="breadcrumb-link">Listado de Equipos </label>
      </li>
      <li class="breadcrumb-item active" aria-current="page">
        {{ nombre }} >
      </li>
    ...
    <CCard class="mb-3">
      ...
      <CCollapse :visible="isExpanded.equipo">
        ...
        <CCardFooter class="card-principal">
          <CButton v-if="sw == 'admin'" class="botoncito" @click="() => { verEditarEquipo = true }">Editar Equipo</CButton>
        </CCardFooter>
      </CCollapse>
    </CCard>
        ...
        <CCardBody>
          ...
          <div v-if="pertenece.length > 0" style="display: flex; flex-direction: column; gap: 10px;">
              ...
              <div class="location-card mb-3 p-3">
                  ...
                  <CButton v-if="sw == 'admin'" color="info" variant="ghost" @click="() => { verAsignacion = true }">Editar Estado</CButton>
                  </div>
              </div>
            </div>
            <CButton v-if="sw == 'admin'" class="botoncito" color="info" variant="ghost" @click="nuevaAsignacion()">Registrar Asignación</CButton>
            <CButton v-if="sw == 'admin'" class="botoncito" color="info" variant="ghost" @click="Asignaciones()">Historial Asignaciónes</CButton>
          ...
          <div v-else class="text-muted" style="display: flex; flex-direction: column; justify-content: space-between; align-items: center;">
            ...
            <CButton v-if="sw == 'admin'" class="botoncito" @click="nuevaAsignacion()">Registrar Asignación</CButton>
          </div>        
        </CCardBody>
      </CCollapse>
    </CCard>
...
<CIcon icon="cil-bell" class="me-2" />
      ...
      <CCollapse :visible="isExpanded.atenciones">
        <CCardBody>
          ...
          <div v-else>
          <CButton  v-if="sw == 'admin'" color="danger" style="width: 100%;" variant="ghost" @click="atenderSolicitud(solicitud.idSolicitud)">Atender</CButton>
          </div>
    
        </div>
        <CButton  v-if="sw == 'admin'" class="botoncito" @click="nuevaSolicitud()">Registrar Solicitud</CButton>
...
<CIcon :icon="isExpanded.ubicaciones ? 'cil-chevron-bottom' : 'cil-chevron-right'" />
    ...
    <div v-if="listaUbicaciones.idUbicacion != null" style="display: flex; flex-direction: column; gap: 10px;">
            ...
            <div class="ubicacion-card mb-3 p-3">
              ...
              <CButton v-if="sw == 'admin'" color="success" variant="ghost" @click="() => { verUbicacion = true }">Desactivar Ubicación</CButton>
            ...
            <CButton v-if="sw == 'admin'" class="botoncito" color="info" variant="ghost" @click="nuevaUbicacion()">Registrar Ubicación</CButton>
            <CButton v-if="sw == 'admin'" class="botoncito" color="info" variant="ghost" @click="Ubicaciones()">Historial Ubicaciones</CButton>
    </div>
          ...
          <div v-if="Red.idRed != null" style="display: flex; flex-direction: column; gap: 10px;">
            <div class="network-card mb-3 p-3">
              ...
              <div class="data-item">
                ...
                <CButton v-if="sw == 'admin'" color="primary" variant="ghost" @click="() => { verRed = true }">Desactivar Red</CButton>
              </div>
            </div>
            <CButton v-if="sw == 'admin'" class="botoncito" color="info" variant="ghost" @click="nuevaRed()">Registrar Red</CButton>
            <CButton v-if="sw == 'admin'" class="botoncito" color="info" variant="ghost" @click="Redes()">Historial de Red</CButton>
          </div>
          <div v-else class="text-muted" style="display: flex; flex-direction: column; justify-content: space-between; align-items: center; gap:10px">
            <p>
      ...
      <CCollapse :visible="isExpanded.software">
        <CCardBody>
          <div v-if="listaSoftware.length > 0" style="display: flex; flex-direction: column; gap: 10px;">
            ...
            <CButton v-if="sw == 'admin'" class="botoncito" color="info" variant="ghost" @click="nuevoSoftware()">Registrar Software</CButton>
            <CButton v-if="sw == 'admin'" class="botoncito" color="info" variant="ghost" @click="Software()">Historial de Software</CButton>
...
export default {
  ...
  data() {
    return {
      cif: this.$route.params.cifCiudadano || '',
      sw: this.$route.params.sw || 'admin',
      isExpanded: {
      equipo: true,
      persona: false,
      pertenece: false,
