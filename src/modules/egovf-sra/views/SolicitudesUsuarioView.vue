                        ...
                        <table id="solicitudTabla" class="table table-striped table-hover">
                            ...
                            <tbody>
                                <tr v-for="solicitud in listaSolicitudes" :key="solicitud.idSolicitud">
                                    ...
                                    <td><CAlert :color="solicitud.evento.color">{{ solicitud.hojaRuta }}</CAlert></td>
                                    <td>
                                      {{solicitud.cite}}
...
export default {
    ...
    methods:{
      ...
      async getListaUsuario(){ // Funcion que crea una lista de Ciudadanos 
        this.egovfService.headersUsuario(this.usuario.token);
        await this.sraService.getListaUsuario(this.gestion,this.mes,this.usuario.sigla).then(response => {
      ...
      pdf(){ //Funcion que Constuye el PDF de la solicitud
            ...
            doc.text("REF.: Evento "+`"${this.solicitudDetalle.evento.nombre}"`,200,120,{align:"right"});
