                  ...
                  <td>
                    <CButtonGroup role="group">
                      ...
                      <CTooltip content="Aprobar Evento y Solicitud" placement="bottom">
                        <template #toggler="{ id, on }">
                          <CButton v-if="estado == 0" :aria-describedby="id" v-on="on" class="font" color="dark"
                            size="sm" @click="getSolicitudAprobar(solicitud.idSolicitud)">
                      ...
                      <CTooltip content="Rechazar o Cancelar Solicitud y Evento" placement="bottom">
                        <template #toggler="{ id, on }">
                          <CButton v-if="estado == 0" :aria-describedby="id" v-on="on" class="font" color="danger"
                            size="sm" @click="updateSolicitudCancelar(solicitud.idSolicitud)">
