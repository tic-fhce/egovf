          ...
          <div class="lg:max-w-xl lg:pr-5 relative z-40">
            ...
            <div class="mt-10 flex flex-col items-center md:flex-row">
              ...
              <CButton @click="volver" title="Volver Atras"
                class="inline-flex h-12 w-full items-center justify-center rounded bg-blue-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-700 focus:outline-none md:mr-1 md:mb-0 md:w-auto">
